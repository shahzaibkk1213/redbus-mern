...
redBus is an Pakistan online bus ticketing platform providing ticket booking facility through its website, iOS and Android mobile apps. It connects bus travellers with a network of over 2500 bus operators, across Pakistan, countries in South East Asia and Latin America.
It connects bus travellers with a network of over 2500 bus operators, across pakistan, countries in South East Asia and Latin America.
...
## How to use the product
 ...
 2. Here you can see our landing page , If you are using this product for the first time , you are a new user and you can login by clicking on dropdown on the right side of navbar and currently we are serving buses between Karachi and Tharparker, so enter Karachi in source and Thar in destination and select any date as per your choice.
