        ...
        <div>
            <div className={Styles.faqDivContainer}>
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                    ...
                    {arrow3 === "upArrow" &&
                        <div className={Styles.faqsEachAnswerDiv}>We are currently operational in Mirpurkhas, Karachi, dubia, Chennai, Hyderabad, Delhi, Multan, Islamabad, Punjab, nagarparker, thar, bahawalpur, china, Coimbatore, Goa, Pondicherry, Erode, Ooty, Udaipur, Jaipur, Guwahati, Trichy and Kolkata.</div>}
                    <div className={Styles.faqsEachDiv}>
                        <div className={Styles.faqDivText}>
